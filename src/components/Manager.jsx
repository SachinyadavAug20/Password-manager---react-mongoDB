...
const Manager = () => {
    ...
    const savePassword = () => {
        ...
        else if (siteName.length <= 4 || !siteName.includes('.') || siteID.length <= 3) {
    ...
    return (
        <>
            ...
            <div>
                ...
                <div className="w-full border-white border-[3px] rounded-r-full h-[36vh] my-5 pr-20 py-5 gap-6 flex-col bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))] overflow-auto">
                    ...
                    <div className="w-full overflow-auto h-[89%]">
                        {passwordArray.map((e, index) => {
                            return <Card key={index} passwordArray={passwordArray} setPasswordArray={setPasswordArray} sitePassword={e.Password} siteName={e.Site} siteNote={e.Note} siteID={e.ID} />
                        })}
                    </div>
                </div>
            </div>
